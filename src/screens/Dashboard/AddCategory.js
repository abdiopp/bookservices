import { View, Text, TextInput, TouchableOpacity, Button, Platform, PermissionsAndroid, Modal, Image } from 'react-native'
...
export default function AddCategory() {
  ...
  const createCategory = async (formData) => {
    try {
      ...
      const childPath = `/categories/${id}.${Type}`;
        ...
        <View style={[styles.horizantlyCenter, styles.flexContainer, { backgroundColor: "#fff" }]}>
          ...
          <View style={[styles.horizantlyCenter, { width: "100%", marginTop: 20 }]}>
            ...
            <TouchableOpacity
              ...
              onPress={toggleModal}
            >
              <Text >Choose category icon</Text>
            </TouchableOpacity>
          </View>
          <TextInput
